...
class NativeDocumentStore:
    ...
    def submit(self, path: str, content: str) -> DocumentWriteTicket: ...
    def write_and_wait(self, path: str, content: str) -> int: ...
...
class GameObject:
    ...
    def _attach_prepared_py_component(self, component_instance: Any) -> Any: ...
...
class AssetDatabase:
    ...
    def import_asset(self, path: str) -> str: ...
    def reimport_asset(self, path: str) -> bool: ...
    def delete_asset(self, path: str) -> bool: ...
    def move_asset(self, old_path: str, new_path: str) -> bool: ...
