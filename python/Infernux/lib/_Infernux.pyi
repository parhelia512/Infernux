...
class Infernux:
    ...
    def schedule_material_preview_task(self, resource_key: str, mat_file_path: str, stamp: int, size: int = 256) -> bool: ...
    def schedule_texture_preview_task(self, resource_key: str, texture_file_path: str, stamp: int,
                                      max_size: int = 256, nearest: bool = False, srgb: bool = False) -> bool: ...
    def pump_preview_tasks(self) -> None: ...
    def get_material_preview_texture_id(self, resource_key: str, expected_stamp: int) -> int: ...
    def get_texture_preview_texture_id(self, resource_key: str, expected_stamp: int) -> int: ...
    def get_texture_preview_size(self, resource_key: str, expected_stamp: int) -> Tuple[int, int]: ...
