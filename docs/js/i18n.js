const translations = {
    en: {
        ...
        "downloadPage.ready": "Release manifest verified locally; downloads resolve to GitHub Releases.",
        ...
        "home.hero.platform": "Windows 10/11 x64 · v0.2.1 technical preview · broader platforms in development",
        ...
        "community.data.local.body": "This site stores language, theme, and optional learning-path progress in localStorage, plus a five-minute copy of public topic metadata in sessionStorage. It sets no first-party account cookie and keeps no user profile.",
        ...
        "community.data.network.body": "The community page may contact GitHub's public API and giscus.app for public topics and comments. Fonts and icons are served from the Infernux origin.",
    ...
    zh: {
        ...
        "downloadPage.ready": "本地发布清单已验证；下载地址指向 GitHub Releases。",
        ...
        "home.hero.platform": "Windows 10/11 x64 · v0.2.1 技术预览 · 更多平台正在开发",
        ...
        "community.data.local.body": "本站在 localStorage 保存语言、主题和可选的学习路径进度，并在 sessionStorage 暂存五分钟的公开话题元数据；不设置第一方账号 Cookie，也不保存用户档案。",
        ...
        "community.data.network.body": "为加载公开话题与评论，社区页可能访问 GitHub 公共 API 与 giscus.app；字体和图标均由 Infernux 自身域名提供。",
