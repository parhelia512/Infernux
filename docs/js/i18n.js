const translations = {
    ...
    zh: {
        ...
        "community.data.local.body": "本站在 localStorage 保存语言、主题和可选的学习路径进度；公开话题元数据缓存五分钟，选择“加载回复”的偏好只通过 sessionStorage 保留在当前标签页。不设置第一方账号 Cookie，也不保存用户档案。",
