const translations = {
    en: {
        ...
        /* Demo */
        "home.demo.kicker": "Performance study · 0.2.1",
        ...
        /* Capabilities */
        "home.capabilities.kicker": "Status board · 0.2.1",
        ...
        "home.status.title": "Release 0.2.1: animation controllers, Timeline, and validated MCP workflows.",
        "home.status.intro": "The engine now includes preview animation controllers, basic Timeline workflows, and a validated MCP control plane for agents; the roadmap still calls out what needs production hardening.",
        "home.status.card1.tag": "CHECKPOINT · 0.2.1",
        ...
        "wiki.start.intro": "The learning track explains the workflow in order. The manual explains systems. The API reference answers exact symbol questions.",
        "wiki.start.card1.tag": "10 minute route",
        ...
        "wiki.start.card2.tag": "Hands-on script",
        ...
        "wiki.start.card3.tag": "Standalone check",
        ...
        "community.feed.intro": "Loaded directly from GitHub's public API. No access token or private profile data is stored in this page.",
        ...
        "community.wall.intro": "Giscus connects this panel to one GitHub Discussion. Sign-in and moderation stay on GitHub.",
        "community.wall.fallback": "If the panel is unavailable, the repository administrator must install the Giscus GitHub App. You can still use Discussions directly.",
    ...
    zh: {
        ...
        /* Capabilities */
        "home.capabilities.kicker": "Operations Board · 0.2.1",
        ...
        "home.status.title": "Release 0.2.1：动画控制器、Timeline，以及强验证 MCP 工作流。",
        "home.status.intro": "引擎现已具备预览阶段的动画控制器、基础 Timeline 工作流，以及经过验证的 MCP 自动化平面；路线图仍标明尚需生产级打磨的部分。",
        "home.status.card1.tag": "CHECKPOINT · 0.2.1",
        ...
        "community.feed.intro": "内容直接来自 GitHub 公共 API；本页不保存访问令牌或私有资料。",
        "community.feed.loading": "正在连接 GitHub 链路……",
        "community.wall.kicker": "社区留言墙",
        "community.wall.title": "不离开网站，也能留下一条简短消息。",
        "community.wall.intro": "Giscus 把此区域连接到一条 GitHub Discussion；登录与管理仍由 GitHub 负责。",
        "community.wall.fallback": "如果面板不可用，仓库管理员需要先安装 Giscus GitHub App；你仍然可以直接使用 Discussions。",
