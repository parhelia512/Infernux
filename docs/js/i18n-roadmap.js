...
globalThis.INFERNUX_PAGE_TRANSLATIONS = {
    "en": {
        ...
        "roadmap.priorities.card1.body": "0.2.9 improves 2D / 3D animation previews, Timeline, animation FSMs, skinned meshes, and shared graph interaction. The next focus is retargeting, blend trees, and runtime control surfaces.",
    ...
    "zh": {
        ...
        "roadmap.priorities.card1.body": "0.2.9 进一步改善了 2D / 3D 动画预览、Timeline、动画 FSM、蒙皮网格与共享图编辑交互。下一步重点是重定向、Blend Tree 与运行时控制面打磨。",
