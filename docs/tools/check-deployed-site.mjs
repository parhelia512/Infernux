...
const checks = [
  { route: "/", type: "text/html", tokens: ["<h1", "data-i18n=\"nav.start\"", "wiki.html?layer=manual#written-guides", "data-i18n=\"home.hero.start\"", "id=\"hero-platform-note\"", "id=\"runtime-capture\"", "https://arxiv.org/abs/2604.10263", "http-equiv=\"Content-Security-Policy\"", "script-src-attr 'none'", "style-src 'self'; style-src-attr 'none'", "data-site-action=\"theme\"", "css/style.css?v=17", "css/home.css?v=1", "css/docs-search.css?v=3", "js/i18n-index.js?v=1", "js/i18n.js?v=18", "js/main.js?v=14", "js/docs-search.js?v=5", "js/home.js?v=1", "data-home-code-copy", "id=\"home-starter-code\"", "id=\"home-code-copy-status\"", "rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"assets/infernux-apple-touch-icon.png\"", "<source srcset=\"assets/demo-0.2.1.avif\" type=\"image/avif\">", "<img src=\"assets/demo-0.2.1.webp\" width=\"1245\" height=\"653\"", "\"screenshot\": \"https://infernux-engine.com/assets/demo-0.2.1.webp\"", ...socialMetaTokens], forbid: ["assets/demo.png", "<source srcset=\"assets/demo-0.2.1.webp\"", "fonts.googleapis.com", "cdnjs.cloudflare.com", "performance is competitive with Unity", "不比Unity差", "onclick=", "<style", " style="] },
  { route: "/wiki.html", type: "text/html", tokens: ["DOCUMENTATION DECK", "data-static-doc-directory", "recent-documents-list", "wiki/site/en/learn/getting-started.html", "wiki/site/zh/manual/engine-map.html", "aria-current=\"page\" data-i18n=\"nav.learn\"", "script-src-attr 'none'", "style-src 'self'; style-src-attr 'none'", "css/wiki-noscript.css?v=1", "css/wiki.css?v=6", "css/style.css?v=17", "css/docs-search.css?v=3", "js/i18n-wiki.js?v=1", "js/i18n.js?v=18", "js/main.js?v=14", "js/docs-search.js?v=5", "js/docs-recent.js?v=1", "js/wiki.js?v=9", ...socialMetaTokens], forbid: ["<style", " style="] },
  { route: "/community.html", type: "text/html", tokens: ["Infernux Community Wall", "up to eight recent document links", "issue-routing-title", "issues/new?template=bug_report.yml", "issues/new?template=feature_request.yml", "issues/new?template=question.yml", "issues?q=is%3Aissue%20is%3Aopen%20label%3Abug", "issues?q=is%3Aissue%20is%3Aopen%20label%3Aenhancement", "issues?q=is%3Aissue%20is%3Aopen%20label%3Aquestion", "community-state", "community-sort", "community-load-more", "id=\"community-share-status\"", "community-browse-all", "giscus-readiness", "giscus-load", "id=\"giscus-sign-in\"", "https://github.com/login?return_to=%2FChenlizheMe%2FInfernux%2Fdiscussions", "data-i18n=\"community.auth.signIn\"", "giscus-thread", "data-loading=\"lazy\"", "data-community-administrators=\"ChenlizheMe\"", "data-i18n=\"community.contract.admin\"", "js/community.js?v=9", "css/community.css?v=10", "js/i18n-community.js?v=3", "js/i18n.js?v=18", "script-src 'self' https://giscus.app", "style-src 'self' https://giscus.app; style-src-attr 'unsafe-inline'", "connect-src 'self' https://api.github.com", "frame-src https://giscus.app", "css/style.css?v=17", "css/docs-search.css?v=3", "js/main.js?v=14", "js/docs-search.js?v=5", ...socialMetaTokens], forbid: ["<script src=\"https://giscus.app/client.js\"", "<style", "client_secret=", "token="] },
  { route: "/download.html", type: "text/html", tokens: ["InfernuxHubInstaller.exe", "data-pwa-install", "id=\"pwa-install-status\"", "id=\"pwa-install-button\"", "downloadPage.webApp.boundary", "downloadPage.signature.none", "downloadPage.verify.boundary", "id=\"all-releases-link\"", "https://github.com/ChenlizheMe/Infernux/releases", "css/download.css?v=2", "js/pwa-install.js?v=1", "js/i18n-download.js?v=2", "js/download.js?v=2", "js/i18n.js?v=18", "css/style.css?v=17", "css/docs-search.css?v=3", "js/main.js?v=14", "js/docs-search.js?v=5", ...socialMetaTokens], forbid: ["signed release manifest"] },
  { route: "/roadmap.html", type: "text/html", tokens: ["<h1", "css/style.css?v=17", "css/docs-search.css?v=3", "js/i18n-roadmap.js?v=1", "js/i18n.js?v=18", "js/main.js?v=14", "js/docs-search.js?v=5", ...socialMetaTokens] },
  ...
  { route: "/site.webmanifest", type: "application/manifest+json", alternateTypes: ["application/json"], tokens: ["\"display_override\"", "\"prefer_related_applications\": false", "infernux-icon-192.png", "infernux-icon-512.png", "infernux-icon-maskable-512.png", "\"purpose\": \"maskable\"", "\"short_name\": \"Start\"", "\"short_name\": \"Docs\"", "\"short_name\": \"Community\"", "\"short_name\": \"Download\"", "/wiki/site/en/learn/getting-started.html", "/community.html"] },
  ...
  { route: "/wiki/site/en/learn/getting-started.html", type: "text/html", tokens: ["data-doc-trail", "data-doc-build-provenance", '"@type": "LearningResource"', "nav-priority active", "aria-current=\"page\">Start", "script-src-attr 'none'", "style-src 'self'; style-src-attr 'none'", "<dialog class=\"docs-search-dialog\"", "id=\"docs-search-filters\"", "/css/docs-search.css?v=3", "/js/docs-search.js?v=5", "data-site-action=\"theme\"", "/css/style.css?v=17", "/js/main.js?v=14", "/css/wiki-generated.css?v=8", "/js/docs-recent.js?v=1", "/js/wiki-generated.js?v=14", "https://github.com/ChenlizheMe/Infernux/blob/master/README.md", ...socialMetaTokens], forbid: ["github.com/ChenlizheMe/Infernux/blob/main/README.md", "<style", " style="] },
  ...
  { route: "/llms.txt", type: "text/plain", alternateTypes: ["application/octet-stream"], tokens: ["Index-Schema: 1", "Index-Content-SHA256", "--- BEGIN INDEX ---", "publisher_signature=not-declared"], minTextBytes: 20_000, maxBytes: 65_536 },
  ...
  { route: "/css/home.css", type: "text/css", tokens: [".code-copy-action", "min-height: 44px", "data-state=\"success\"", "data-state=\"failure\"", ".home-copy-fallback", "@media (max-width: 520px)"] },
  ...
  { route: "/css/wiki-generated.css", type: "text/css", tokens: [".doc-build-provenance", ".doc-diagram", ".clipboard-fallback", ".doc-trail-action[data-state=\"success\"]", ".doc-trail-action[data-state=\"failure\"]", ".doc-trail-action span", "grid-template-columns: repeat(2, minmax(0, 1fr))", "overscroll-behavior-inline: contain", "@media print", "break-inside: avoid-page", "display: table-header-group", "white-space: pre-wrap"] },
  { route: "/css/community.css", type: "text/css", tokens: [".forum-controls", ".forum-pagination", ".topic-signals", ".topic-main", ".topic-action", ".community-copy-fallback", ".giscus-readiness", ".giscus-install-action"] },
  { route: "/css/download.css", type: "text/css", tokens: [".pwa-install", ".pwa-install-control [hidden]", "data-install-state=\"ready\""] },
  { route: "/js/i18n.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["translateSiteKey", "INFERNUX_PAGE_TRANSLATIONS", "requestedPageLanguage", "URLSearchParams(window.location.search)"] },
  { route: "/js/i18n-index.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["home.hero.title", "home.demo.panel.item3"] },
  { route: "/js/i18n-wiki.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["wiki.hero.title", "wiki.health.title"] },
  { route: "/js/i18n-roadmap.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["roadmap.hero.title", "roadmap.priorities.title"] },
  { route: "/js/i18n-community.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["community.hero.title", "community.issue.bug.title"] },
  { route: "/js/i18n-download.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["downloadPage.webApp.status.iosSafari", "downloadPage.webApp.status.unavailable"] },
  { route: "/js/docs-search.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["/api-index.json", "function buildSearchModel", "function buildWikiSearchUrl", "docs-search-wiki-continuation", "languageFilter.value", "statusFilter.value"] },
  { route: "/js/docs-recent.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["infernux-recent-documents-v1", "MAX_ITEMS = 8", "MAX_AGE_MS", "InfernuxRecentDocuments"] },
  { route: "/js/main.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["mobileMenuFocusables", "handleMobileMenuKeydown", "handleMobileMenuPointerDown", "mobile-menu-open", "bindSiteActions", "is-scrolled", "reveal-pending", "data-site-action", "monitorServiceWorkerUpdates", "SKIP_WAITING", "controllerchange", "site-update-notice", "SITE_THEME_COLORS", "updateThemeColor"] },
  { route: "/js/home.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["extractStarterCode", "copyHomeText", "data-home-code-copy", "home-code-copy-status", "document.execCommand(\"copy\")", "site:language-changed"] },
  { route: "/js/docs-health.js", type: "text/javascript", alternateTypes: ["application/javascript"], token: "normalizeDocsHealth" },
  { route: "/js/wiki.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["currentSelectedLayer === \"api\"", "wikiUrlStateRestored", "if (!wikiUrlStateRestored) return"] },
  { route: "/js/wiki-generated.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["initializeBuildProvenance", "recordRecentDocument", "InfernuxRecentDocuments", "Copy section link", "复制章节链接", "buildSectionUrl", "copyText(target.url)", "LANGUAGE_SECTION_PARAMS", "buildLanguageSectionUrl", "resolveLanguageSectionUrl", "restoreTransferredLanguageSection", "window.history.replaceState", "scrollIntoView", "visibleDocumentSection", "resolveDocumentSectionId", "dataset.currentSection", "dataset.sectionTracking", "site:document-section-changed", "requestAnimationFrame(syncVisibleSection)", "passive: true", "Print / Save PDF", "打印 / 保存 PDF", "window.print()", "Edit this page", "在 GitHub 编辑本文", "View generated Markdown", "查看生成 Markdown", "buildContributionSourceUrl", "/edit/master/", "/blob/master/"] },
  { route: "/js/community.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["COMMUNITY_CACHE_TTL_MS", "sort=updated", "communityNextPage", "mergeCommunityTopics", "copyCommunityText", "shareOrCopyCommunityTopic", "activateCommunityTopicAction", "community-share-status", "navigator?.share", "navigator?.canShare", "navigator?.clipboard?.writeText", "document.createElement(\"time\")", "updated.dateTime = topic.updated_at", "GISCUS_OPT_IN_KEY", "GISCUS_CONTROLLER_SRC", "ensureGiscusController", "loadDeferredGiscus", "document.createElement(\"script\")"] },
  { route: "/js/community-giscus.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["GISCUS_ORIGIN", "GISCUS_SCRIPT_ID", "globalThis.InfernuxGiscus = controller", "event.origin !== GISCUS_ORIGIN", "event.source !== frame.contentWindow", "script.src = `${GISCUS_ORIGIN}/client.js`", "new MutationObserver(syncConfig)"] },
  { route: "/js/download.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["normalizeReleaseManifest", "publisher_signature", "asset URL must match the canonical release tag and filename", "grid.replaceChildren()"] },
...
try {
  ...
  if (siteRelease.schema_version !== 2) throw new Error(`unsupported release schema ${siteRelease.schema_version}`);
  if (siteRelease.verification?.checksum_algorithm !== "SHA-256") throw new Error("release manifest does not declare SHA-256 verification");
  if (siteRelease.verification?.publisher_signature !== "not-declared") throw new Error("publisher-signature boundary is missing or inaccurate");
  if (siteRelease.verification?.authority !== "GitHub Releases") throw new Error("release authority differs from GitHub Releases");
...
try {
  ...
  // A plain local static server returns its own generic error document instead
  // of GitHub Pages' checked-in 404.html. Keep the missing-route status check,
  // then validate the published recovery source directly for local previews.
  if (localPreview && allowUnstamped && !body.includes('data-title-i18n="error.title"')) {
    const recovery = await fetch(new URL("/404.html", base), {
      headers: { "user-agent": "Infernux-website-health/1.0" },
      signal: AbortSignal.timeout(15_000),
    });
    if (!recovery.ok) throw new Error(`local 404 recovery source returned HTTP ${recovery.status}`);
    body = await recovery.text();
  }
  for (const token of [
    ...
    if (!body.includes(token)) throw new Error(`custom 404 is missing recovery contract '${token}'`);
  }
