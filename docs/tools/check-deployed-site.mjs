...
const checks = [
  ...
  { route: "/community.html", type: "text/html", tokens: ["community-state", "community-sort", "community-load-more", "id=\"community-share-status\"", "community-browse-all", "<dialog class=\"forum-compose\"", "id=\"community-body-editor\"", "giscus-readiness", "giscus-load", "giscus-thread", "data-loading=\"lazy\"", "data-community-administrators=\"ChenlizheMe\"", "js/community.js?v=11", "css/community.css?v=13", "js/i18n-community.js?v=6", "js/i18n.js?v=18", "script-src 'self' https://giscus.app", "style-src 'self' https://giscus.app; style-src-attr 'unsafe-inline'", "connect-src 'self' https://api.github.com", "frame-src https://giscus.app", "css/style.css?v=17", "css/docs-search.css?v=3", "js/main.js?v=14", "js/docs-search.js?v=5", ...socialMetaTokens], forbid: ["id=\"community-auth\"", "id=\"giscus-sign-in\"", "data-i18n=\"community.contract.admin\"", "<script src=\"https://giscus.app/client.js\"", "<style", "client_secret=", "token="] },
  { route: "/community-topic.html?topic=11", type: "text/html", tokens: ["id=\"community-topic\"", "id=\"topic-body\"", "id=\"topic-replies\"", "data-mapping=\"number\"", "js/community-topic.js?v=2", "js/i18n-community-topic.js?v=1", "css/community.css?v=13", "connect-src 'self' https://api.github.com", "frame-src https://giscus.app", ...socialMetaTokens], forbid: ["<script src=\"https://giscus.app/client.js\"", "<style", "client_secret=", "token="] },
  { route: "/download.html", type: "text/html", tokens: ["data-release-kind=\"hub-installer\"", "data-pwa-install", "id=\"pwa-install-status\"", "id=\"pwa-install-button\"", "downloadPage.webApp.boundary", "downloadPage.signature.none", "downloadPage.verify.boundary", "id=\"all-releases-link\"", "https://github.com/ChenlizheMe/Infernux/releases", "css/download.css?v=2", "js/pwa-install.js?v=1", "js/i18n-download.js?v=2", "js/download.js?v=2", "js/i18n.js?v=18", "css/style.css?v=17", "css/docs-search.css?v=3", "js/main.js?v=14", "js/docs-search.js?v=5", ...socialMetaTokens], forbid: ["signed release manifest"] },
  ...
  { route: "/js/i18n-community.js", type: "text/javascript", alternateTypes: ["application/javascript"], tokens: ["community.forum.title", "community.compose.title"] },
